...
<head>
    ...
    <title>Portafolio - Agenda y personaje</title>
...
<body>
    ...
    <!-- top-bar -->
    <div class="top-bar">
        <h1>AGENDA y personaje</h1>
        <p><a href="{{route('index')}}">Inicio</a> / <a href="{{route('portfolio')}}">portafolio</a> / AGENDA y personaje</p>
    </div>
    <!-- end top-bar -->
    ...
    <div class="container main-container" style="margin-left: 150px;">
        <div class="col-md-12" style="width: 1490px;">
            <img src="img/portfolio/proceso/12.png" alt="" width="350" height="350" />
            <img src="img/portfolio/proceso/13.png" alt="" width="350" height="350" />
            <img src="img/portfolio/proceso/14.png" alt="" width="350" height="350" />
            <img src="img/portfolio/proceso/15.png" alt="" width="350" height="350" />
            <img src="img/portfolio/proceso/16.png" alt="" width="350" height="350" />
            <img src="img/portfolio/proceso/17.png" alt="" width="350" height="350" />
            <img src="img/portfolio/proceso/18.png" alt="" width="350" height="350" />
            <div class="h-30"></div>
        </div>

        <div class="col-md-12">
            <h3 class="text-uppercase">AGENDA y personaje</h3>
            <h5>Creación No. 3</h5>
            <div class="h-30"></div>
        </div>

        <div class="col-md-12">
            <p align="justify">Un planificador de productividad y gratitud, diseñado específicamente para ayudarte A alcanzar tus objetivos.</p>

            <p align="justify">Este planificador personal es todo acerca de la responsabilidad, lo que te guía a través de establecer las esferas y objetivos diarios.</p>
        </div>
